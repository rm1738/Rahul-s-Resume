...
\vspace{-1.2\baselineskip} % Reduce by one line height
...
\begin{itemize}[leftmargin=0mm, label={}, itemsep=1pt]  % Reduce itemsep for closer job entries
  ...
  \small \textit{Contract • New York, New York} \vspace{-0.1\baselineskip}  % Reduced vertical space after the title
  ...
  \small \textit{Blacksburg, Virginia} \vspace{-0.1\baselineskip}  % Reduced vertical space after the title
  \begin{itemize}[leftmargin=5mm, itemsep=0pt, topsep=0pt]  % Reduce itemsep between bullet points
